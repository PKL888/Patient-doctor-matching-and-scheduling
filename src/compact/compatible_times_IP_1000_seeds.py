...
def compatible_times_model(data, objective):
    globals().update(data)

    # Initialise model
    m = gp.Model("Compatible_times")
    ...
    elif objective == "doctor_satisfaction":
        m.setObjective(
