...
# Input instance
instance = "data_seed10_I100_J10_K4_T20.pkl"
...
def compute_pareto_set(use_slack=True, verbose=True):
    ...
    return pareto_frontier, dominated_points, pareto_solutions

# Compute Pareto sets
# pareto_slack = compute_pareto_set(use_slack=True)
pareto_slack, dom_slack, all_slack = compute_pareto_set(use_slack=True)
